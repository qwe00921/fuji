...
public class SellerInformationActivity extends BaseActivity implements OnClickListener {
    ...
    public void bindEvent() {
        ...
        /*
         * tvsellerinfoPhone.setOnClickListener(this); btncall.setOnClickListener(this);
         */
    ...
    public void onClick(View arg0) {
        ...
        case R.id.btn_groupbuy_sellerinformation_back:
            ...
            break;
        /*
         * case R.id.tv_groupbuy_sellerinformation_phonedetails: case R.id.btn_groupbuy_sellerinfo_call :
         */
                ...
                if (jsonStr.equals("-1")) {
                    ...
                    try {
                        ...
                        if (json.equals("")) {
                            ...
                            ImageLoaderHelper.displayImage(imgsellerlogo, json.getString("imageUrl"));
