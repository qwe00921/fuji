...
public class ShoppingcartOrderAdapter extends BaseExpandableListAdapter {
    ...
    public ShoppingcartOrderAdapter(Context baseContext, List<ShopsDetailInfoEntity> shopList, List<List<ShoppingcartInfoEntity>> shoppingcartInfoAll, ConsigneeAddressEntity addressEntity) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ImageLoaderHelper.displayImage(holder.ivGoods, shoppingcartInfoAll.get(groupPosition).get(childPosition).getImageUrl());
    ...
    class ChildTextChange implements TextWatcher {
        ...
        public ChildTextChange(int groupPosition, int childPosition, EditText etNote, Context context) {
            // TODO Auto-generated constructor stub
            this.groupPosition = groupPosition;
            this.childPosition = childPosition;
            this.etNote = etNote;
