...
public class MycenterCollectMainAdapter extends BaseAdapter {
    ...
    public MycenterCollectMainAdapter(Context context, List<GoodsEntity> list) {
    ...
    public MycenterCollectMainAdapter(Context context, List<GoodsEntity> list, int is_select[], int is_writting) {
        // TODO Auto-generated constructor stub
        this.context = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (is_select[position] == 2) {
            ...
            ImageLoaderHelper.displayImage(holder.ivGoods, list.get(position - m).getImageUrl());
