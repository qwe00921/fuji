...
public class ShoppingmallGoodsListAdapter extends BaseAdapter {
    ...
    public ShoppingmallGoodsListAdapter(Context context, List<GoodsEntity> list) {
    ...
    public ShoppingmallGoodsListAdapter(Context baseContext, List<GoodsEntity> pageData, boolean isShoppingmall2) {
        // TODO Auto-generated constructor stub
