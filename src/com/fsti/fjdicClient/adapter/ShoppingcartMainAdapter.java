...
public class ShoppingcartMainAdapter extends BaseExpandableListAdapter {
    ...
    public void setShoppingcartInfoAll(List<List<ShoppingcartInfoEntity>> shoppingcartInfoAll) {
        this.shoppingcartInfoAll = shoppingcartInfoAll;
    }

    public ShoppingcartMainAdapter(Context context, List<ShopsDetailInfoEntity> shopList, List<List<ShoppingcartInfoEntity>> shoppingcartInfoAll) {
    ...
    // 多了总价和总数两个控件
    public ShoppingcartMainAdapter(Context context, List<ShopsDetailInfoEntity> shopList, List<List<ShoppingcartInfoEntity>> shoppingcartInfoAll, TextView tvListGoodscount, TextView tvListTotalPrice) {
        // TODO Auto-generated constructor stub
        this.shoppingcartInfoAll = shoppingcartInfoAll;
        this.shopList = shopList;
        this.context = context;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (childPosition == shoppingcartInfoAll.get(groupPosition).size() - 1) {
            ...
            for (int q = 0; q < freightTypeArray.length; q++) {
                ...
                holder.view = LayoutInflater.from(holder.llFreight.getContext()).inflate(R.layout.layout_list_item_shoppingcart_freightchoice, null);
        ...
        holder.tvShowWhichFreight.setText("运送方式：" + freightTypeArray[shoppingcartInfoAll.get(groupPosition).get(childPosition).getFreightTypeSelect()]);
        ...
        ImageLoaderHelper.displayImage(holder.ivGoods, url);
    ...
    class ChildCheck implements OnClickListener, TextWatcher {
        ...
        public ChildCheck(int groupPosition, int childPosition, EditText etCounts, Context context) {
            // TODO Auto-generated constructor stub
            this.groupPosition = groupPosition;
            this.childPosition = childPosition;
        ...
        public ChildCheck(int groupPosition, int childPosition, LinearLayout rlFrightChoice, RelativeLayout rlFrightShow) {
            // TODO Auto-generated constructor stub
            this.groupPosition = groupPosition;
            this.childPosition = childPosition;
        ...
        public ChildCheck(int groupPosition, int childPosition, ImageView ivselect) {
            // TODO Auto-generated constructor stub
            this.groupPosition = groupPosition;
            this.childPosition = childPosition;
        ...
        public void onClick(View v) {
            ...
            case R.id.rl_shoppingcart_freight_insert:
                ...
                for (int i = 0; i < shoppingcartInfoAll.get(groupPosition).size(); i++) {
                    ...
                    BusinessDao.updateShoppingcartTableData(BusinessDao.Table_Name_ShoppingcartInfo, shoppingcartInfoAll.get(groupPosition).get(i), GlobalVarUtil.account.getUID());
                }
                totalPriceAndCounts(shoppingcartInfoAll);
        ...
        private void overStepCounts(int counts) {
            ...
            try {
                String jsonStr = HttpUtil.postData(reqUrl, parameters, GlobalVarUtil.ENCODING);
                if (jsonStr.equals("-1")) {
                    ...
                    if (counts <= storageCount) {
                        ...
                        BusinessDao.updateShoppingcartTableData(BusinessDao.Table_Name_ShoppingcartInfo, shoppingcartInfoAll.get(groupPosition).get(childPosition), GlobalVarUtil.account.getUID());
