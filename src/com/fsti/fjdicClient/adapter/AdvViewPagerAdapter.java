...
public class AdvViewPagerAdapter extends PagerAdapter {
	...
	public AdvViewPagerAdapter(ArrayList<View> imgViews,List<AdvEntity> adList,SyncImageLoadUtil silu,OnImageLoadListener listener)
	{
	...
	public AdvViewPagerAdapter(ArrayList<View> imgViews,List<AdvEntity> adList,SyncImageLoadUtil silu,OnImageLoadListener listener,Context context)
	{
